...
//    @Autowired
//    public void setDataSource(@Qualifier("dataSource") DataSource dataqinyaSource){
//        this.jdbcTemplate = new JdbcTemplate(dataqinyaSource);
//    }
     ...
     * @return
     */
    public String saveAndGetStringId(final String sql, final Object[] params) {
        //LogFactory.getLog(this.getClass()).info("insert sql:"+sql+",["+StringUtil.join(params,",")+"]");
        KeyHolder keyHolder = new GeneratedKeyHolder();
        jdbcTemplate.update(new PreparedStatementCreator() {
            @Override
